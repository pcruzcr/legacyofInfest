...
| **P3-03** | P3 Bajo | Audio/Docs | **DEFERRED** | `assets/maps/boss_paburu/boss_paburu.tmx` | 9 props `catacumba_*` warn | Props experimentales no leídas | warn spam | Bajo | Quitar props o documentar en `06_TMX_SPEC` | `validate_tmx` warn | `validate_tmx` |
| **P3-04** | P3 Bajo | Nivel | **DEFERRED** | `assets/maps/stage2_2/stage2_2.tmx`, `stage3_1` | `schema_version` missing, `DeathPit` en `Collision` | Mapa antiguo pre-`schema_version` | warn | Bajo | Añadir prop `schema_version 1`, mover `DeathPit` a `Objects` | `validate_tmx` warn | `validate_tmx` |
