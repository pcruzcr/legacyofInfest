...
| 4-1b Fosa abisal (variante) | `bgm_splash` | abisal, congelado, `ambient_light=0.28` | — | señuelo bioluminiscente del pez abismal | 1 (pez abismal, sin daño) | `WaterZone` de principio a fin; persecución sin combate |
