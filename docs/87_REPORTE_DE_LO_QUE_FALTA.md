...
| **5. GPU** | La ruta de sprites en tarjeta (quads instanciados, composición en GPU según `docs/74`), aislada y medible con `scripts/bench_sprite_batch.py`; activable por contexto. Incluye **normal mapping** (pedido 2026-08-07): normales por sprite y luz direccional/puntual en los shaders | Pendiente, proyecto de varias sesiones |
...
| **Niebla de guerra animado** | Pendiente (AUD-338) — el velo estático de `fog_of_war.py` (AUD-111/213) pasa a respirar |
