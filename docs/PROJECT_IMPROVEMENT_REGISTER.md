...
| **I-007** | `CONTENT/P2` | `B1-B4` riqueza barata `FEATURE→RULE→DATA→UI→SAVE→WORLD→TEST→PLAYTEST` | Aumentar rejugabilidad sin arquitectura | Alto | Medio 4 features secuenciales | Medio | **P1 después Playtest** | HOLD (B2 DONE, faltan B1/B3/B4) |
