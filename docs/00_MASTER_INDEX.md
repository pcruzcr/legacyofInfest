...
| --- | ------------------------------------ | --------------------------------------- | -------------------------------------------------------------------- |
| 77  | [[`77_SYLLABUS_ALIGNMENT_AUDIT.md`]] | v4 (`legacy_of_infest_docs_corrected/`) | Current                                                              |
...
| 78  | `78_SAMPLE_SYLLABUS.md`              | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
| 29  | `29_GIT_WORKFLOW_AND_STANDARDS.md`   | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
| 79  | `79_TA_GUIDE.md`                     | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
| 80  | `80_TICKET_BACKLOG.md`               | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
| 30b | `30_ASSIGNMENT_01_STAGE_DESIGN.md`   | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
| 81  | `81_RISK_REGISTER.md`                | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
| 31b | `31_ASSIGNMENT_02_BOSS_DESIGN.md`    | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
| 82  | `82_ENVIRONMENT_SETUP_GUIDE.md`      | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
| 32b | `32_ASSIGNMENT_03_LAB_EXERCISES.md`  | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
| 83  | `83_SCOPE_ADJUSTMENT.md`             | v6 (`legacy_of_infest_docs_v6/`)        | Current                                                              |
...
| 84  | `84_EDUCATIONAL_ROADMAP.md`          | v11 (in-repo, 2026-07-11)               | Current — educational roadmap                                        |
...
| 85  | `[[85_MULTIDISCIPLINARY_AUDIT.md]]`  | v12 (in-repo, 2026-07-14)              | Current — multi-disciplinary audit with 44 category scores           |
...
| 86  | `86_ESPECIFICACION_DE_NIVELES_Y_JEFES.md` | v1 (in-repo)                     | Current — mandatory level/boss rules per deliverable 1-2-3 + day/night arcs; per-level sheets in `docs/niveles/` (Spanish) |
...
| 73  | `73_CATALOGO_DE_RECURSOS_PARA_ESTUDIANTES.md` | v1 (in-repo)                  | Current — verified catalog of player states/actions, enemy states + 8 archetypes + 21 species, and the 34 TMX object types + ECS components + events + VFX (Spanish) |
| 74  | `74_TUBERIA_DE_GPU.md`               | v1 (in-repo)                            | Current — single reference for the GL post-processing pipeline: pass order, CPU/GPU split, costs measured on real hardware, how a stage enables each effect (Spanish) |
| 75  | `75_BIBLIA_TECNICA.md`               | v1 (in-repo)                            | Current — exhaustive technical bible cross-referencing docs vs code: mechanics, player states, enemies, bosses, TMX level design, VFX, full framework/engine API, CLI scripts, tools, tests, and the implemented/orphaned/half-done audit (Spanish) |
| 76  | `76_PLAN_DE_CIERRE.md`               | v1 (in-repo)                            | Current — single backlog of what is left: functional defects, orphaned systems, half-done features, blocking design decisions, desynchronised docs, and the proposed order of attack (Spanish) |
| 87  | `87_REPORTE_DE_LO_QUE_FALTA.md`      | v1 (in-repo)                            | Current — measured QA status per system: game modes, GPU, progression, UI, navigation, saves, and the open Gavilán assignment (Spanish) |
...
| Document | Answers |
|---|---|
| `77_SYLLABUS_ALIGNMENT_AUDIT.md` | What does the official syllabus actually say, and where did earlier drafts deviate from it? |
...
| `81_RISK_REGISTER.md` | What academic/pedagogical risks exist and how are they mitigated? |
...
| `80_TICKET_BACKLOG.md` | Every roadmap phase decomposed into atomic tickets |
| `82_ENVIRONMENT_SETUP_GUIDE.md` | Step-by-step machine setup, troubleshooting |
...
2. 77_SYLLABUS_ALIGNMENT_AUDIT.md   — understand what's authoritative
3. 02_CODEX_CONTEXT.md              — understand the rules
4. 25_IMPLEMENTATION_ROADMAP.md     — understand the build order
5. 80_TICKET_BACKLOG.md             — pick up Phase 0, Ticket T0.1
...
2. 82_ENVIRONMENT_SETUP_GUIDE.md    — verify it works on your own machine first
...
6. 81_RISK_REGISTER.md §8           — review open risks before term start
```

### 4.3 "I am a student starting my assignment"

```
1. 82_ENVIRONMENT_SETUP_GUIDE.md    — get your machine working
...
|---|---|---|---|
| `77_SYLLABUS_ALIGNMENT_AUDIT.md` | Any document issued before it | Audit wins | It is the authoritative reconciliation against the real syllabus |
...
| v12 (2026-07-14) | 85_MULTIDISCIPLINARY_AUDIT.md | 1 new | — |
...
Any further documents should be **generated only in response to a concrete gap discovered during actual implementation** (logged first in `KNOWN_GAPS.md` per `23_DATA_SCHEMAS.md` §8, and in `81_RISK_REGISTER.md` if it represents an ongoing risk rather than a one-time gap) — not speculatively.

The two items previously tracked as open/deferred have both been resolved by professor confirmation:

1. **Matplotlib's role** — confirmed as classroom/lab-instructional use only (per `21_COURSE_SCHEDULE.md`'s Quices/Labs), not a Legacy of InFest framework integration point. No `src/` call site is required. (`81_RISK_REGISTER.md` RISK-A03, closed.)
2. **El Gavilán Camionero Mascarero** — confirmed as the official, permanent Zone 3 boss, no longer pending or subject to reassignment. (`81_RISK_REGISTER.md` RISK-A04, closed; `28_DECISION_LOG.md` ADR-008, accepted final.)
...
- [[77_SYLLABUS_ALIGNMENT_AUDIT.md|Syllabus Alignment Audit]]
...
- [[78_SAMPLE_SYLLABUS.md|Sample Syllabus]]
- [[29_GIT_WORKFLOW_AND_STANDARDS.md|Git Workflow]]
- [[79_TA_GUIDE.md|TA Guide]]
...
- [[83_SCOPE_ADJUSTMENT.md|Scope Adjustment]]
...
|---|---|---|---|
| 77  | [[77_SYLLABUS_ALIGNMENT_AUDIT.md]] | v4 (legacy_of_infest_docs_corrected/) | Actual |
...
| 78  | 78_SAMPLE_SYLLABUS.md | v6 (legacy_of_infest_docs_v6/) | Actual |
| 29 | 29_GIT_WORKFLOW_AND_STANDARDS.md | v6 (legacy_of_infest_docs_v6/) | Actual |
| 79  | 79_TA_GUIDE.md | v6 (legacy_of_infest_docs_v6/) | Actual |
| 80  | 80_TICKET_BACKLOG.md | v6 (legacy_of_infest_docs_v6/) | Actual |
| 30b | 30_ASSIGNMENT_01_STAGE_DESIGN.md | v6 (legacy_of_infest_docs_v6/) | Actual |
| 81  | 81_RISK_REGISTER.md | v6 (legacy_of_infest_docs_v6/) | Actual |
| 31b | 31_ASSIGNMENT_02_BOSS_DESIGN.md | v6 (legacy_of_infest_docs_v6/) | Actual |
| 82  | 82_ENVIRONMENT_SETUP_GUIDE.md | v6 (legacy_of_infest_docs_v6/) | Actual |
| 32b | 32_ASSIGNMENT_03_LAB_EXERCISES.md | v6 (legacy_of_infest_docs_v6/) | Actual |
| 83  | 83_SCOPE_ADJUSTMENT.md | v6 (legacy_of_infest_docs_v6/) | Actual |
...
| 84  | 84_EDUCATIONAL_ROADMAP.md | v11 (en-repo, 2026-07-11) | Actual — hoja de ruta educativa |
...
| 85  | [[85_MULTIDISCIPLINARY_AUDIT.md]] | v12 (en-repo, 2026-07-14) | Actual — auditoría multidisciplinaria con puntuaciones de 44 categorías |
...
**Acción recomendada antes de comenzar la implementación:** Consolidar todos los documentos de estado actual en una sola carpeta docs/ en el repositorio real (según la estructura de 77_SYLLABUS_ALIGNMENT_AUDIT.md sección 7), descartando los originales reemplazados v1/v2/v3 de los seis documentos listados como "reemplaza" arriba. Este índice se vuelve redundante una vez que ocurre esa consolidación — en ese punto, una simple lista numerada de la carpeta docs/ se explica por sí misma.
...
| Documento | Responde |
|---|---|
| 77_SYLLABUS_ALIGNMENT_AUDIT.md | ¿Qué dice realmente el programa de estudios oficial, y dónde se desviaron los borradores anteriores? |
...
| 81_RISK_REGISTER.md | ¿Qué riesgos académicos/pedagógicos existen y cómo se mitigan? |
...
| 80_TICKET_BACKLOG.md | Cada fase de la hoja de ruta descompuesta en tickets atómicos |
| 82_ENVIRONMENT_SETUP_GUIDE.md | Configuración paso a paso de la máquina, solución de problemas |
...
2. 77_SYLLABUS_ALIGNMENT_AUDIT.md   — entender qué es autoritativo
3. 02_CODEX_CONTEXT.md              — entender las reglas
4. 25_IMPLEMENTATION_ROADMAP.md     — entender el orden de construcción
5. 80_TICKET_BACKLOG.md             — tomar la Fase 0, Ticket T0.1
...
2. 82_ENVIRONMENT_SETUP_GUIDE.md    — verificar que funcione en su propia máquina primero
...
6. 81_RISK_REGISTER.md seccion 8    — revisar riesgos abiertos antes del inicio del semestre

### 4.3 "Soy un estudiante comenzando mi asignación"

1. 82_ENVIRONMENT_SETUP_GUIDE.md    — preparar su máquina
...
|---|---|---|---|
| 77_SYLLABUS_ALIGNMENT_AUDIT.md | Cualquier documento emitido antes que él | Gana la Auditoría | Es la reconciliación autoritativa contra el programa de estudios real |
...
| v12 (2026-07-14) | 85_MULTIDISCIPLINARY_AUDIT.md | 1 nuevo | - |
...
Cualquier documento adicional debe ser **generado solo en respuesta a una brecha concreta descubierta durante la implementacion real** (registrada primero en KNOWN_GAPS.md segun 23_DATA_SCHEMAS.md seccion 8, y en 81_RISK_REGISTER.md si representa un riesgo continuo en lugar de una brecha puntual) — no especulativamente.

Los dos elementos previamente rastreados como abiertos/diferidos han sido resueltos por confirmacion del profesor:

1. **El rol de Matplotlib** — confirmado como uso exclusivo en aula/laboratorio instruccional (segun los Quices/Labs de 21_COURSE_SCHEDULE.md), no un punto de integracion del marco Legacy of InFest. No se requiere ningun sitio de llamada en src/. (RISK-A03 de 81_RISK_REGISTER.md, cerrado.)
2. **El Gavilan Camionero Mascarero** — confirmado como el jefe oficial y permanente de la Zona 3, ya no pendiente ni sujeto a reasignacion. (RISK-A04 de 81_RISK_REGISTER.md, cerrado; ADR-008 de 28_DECISION_LOG.md, aceptado final.)
...
- [[77_SYLLABUS_ALIGNMENT_AUDIT.md|Auditoria de Alineacion del Programa]]
