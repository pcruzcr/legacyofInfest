...
class TestElGateLoVigila:
    ...
    def test_el_validador_pasa_con_los_catalogos_de_hoy(self) -> None:
        ...
        completado = subprocess.run(
            ...
            [sys.executable, "scripts/check_translations.py", "--ci", "--permitted-orphans", str(RAIZ / "locale" / "permitted_orphans.json")],  # noqa: E501
    ...
    def test_el_validador_falla_si_le_quitas_una_traduccion(
        ...
        monkeypatch.setattr(sys, "argv", ["check_translations.py", "--ci", "--permitted-orphans", str(RAIZ / "locale" / "permitted_orphans.json")])  # noqa: E501
