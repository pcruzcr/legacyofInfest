...
class TestLosCatalogosEstanSanos:
    ...
    def test_no_hay_entradas_huerfanas(self, idioma):
        ...
        HUERFANAS_PERMITIDAS_ES = {
            ...
            "TRANSFORM LAB", "VECTOR LAB", "VISION DEMO", "Cancel", "Confirm", "Demo", "Move", "Select", "STUDENT",
            ...
            "UNIT VII/VIII", "UNIT VIII", "Jump", "Pause", "Dash", "Grab",
            ...
            "Move Up", "Move Down", "FREE MOVE", "CHASE (normalized)", "ORBIT (dot product)", "DISTANCE CHECK",
        ...
        HUERFANAS_PERMITIDAS_EN = {
            ...
            "Cancelar", "Confirmar", "Demostración", "ESTUDIANTE",
            ...
            "Siguiente", "Subir rango", "TEMARIO", "TRANSFORM LAB",
            ...
            "Aceptar", "Accept", "STUDENT", "Confirm", "Move", "Select", "Cancel", "Change", "Back", "Exit", "Jump", "Next", "Choose", "Enter", "Move Left", "Move Right", "Move Up", "Move Down",  # noqa: E501



            "Crouch", "Dash", "Grab", "Pause", "FREE MOVE", "CHASE (normalized)", "ORBIT (dot product)", "DISTANCE CHECK", "What does Vector2.normalize() return?", "A zero vector", "A unit vector (length=1)", "The vector scaled by 2", "The vector's angle", "What is the dot product of two perpendicular vectors?",  # noqa: E501



            "1", "0", "Their product", "Undefined", "What curve uses 4 control points?", "Linear", "Quadratic Bezier", "Cubic Bezier", "Catmull-Rom", "What does distance() between two points return?",  # noqa: E501



            "The straight-line length", "The X difference", "The Y difference", "The sum of coordinates", "What does a normalized vector represent?", "Magnitude only", "Direction only", "Position only", "Speed only", "What is cos(90 degrees)?", "-1", "0.5", "RGB EXPLORER", "HSV EXPLORER", "HSL EXPLORER", "CMYK EXPLORER", "ALPHA BLEND", "CHALLENGE", "SHIFT to toggle step-by-step algorithm", "Press Z (light) or X (heavy)", "Light", "Heavy", "Chain: Z \u2192 Z \u2192 X", "Combo window", "Combo: x{count}", "Combo: \u2014", "Multiplier: {mult}x", "INFERENCE", "FEATURE_COMPARE", "CLASS_GRID", "CONFUSION", "PIPELINE", "TREE_VIEW", "Source Feature Vector:", "Nearest Training Sample:", "No tree structure available for this model", "THRESHOLD", "OTSU", "ERODE", "DILATE", "OPEN", "CLOSE", "COMPONENTS",  # noqa: E501
            ...
            "No questions loaded", "QUIZ", "Score: {score}", "Confirm",  # noqa: B033
            ...
            "START", "WORLD MAP", "INVENTORY", "SKILL TREE", "SHOP", "RECORDS", "ACADEMIC DEMOS", "OPTIONS", "QUIT",
            ...
            "VECTOR LAB", "VISION DEMO", "Attack (Short)", "Attack (Long)", "ui.score",  # noqa: B033
