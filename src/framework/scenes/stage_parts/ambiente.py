...
class MezclaDeAmbiente:
    ...
    def _setup_lighting(self) -> None:
        ...
        # AUD-598 — GAP-072.4: las zonas de brillo ambiental del mapa.
        # Vacía (o ausente, en mapas viejos) = el brillo base manda en todo
        # el nivel como toda la vida.
        self._zonas_luz_ambiente = list(
            getattr(self._stage_data, "zonas_luz_ambiente", []))
