...
def _spawn_walker(prefab: dict[str, Any], stage: StageData, props: dict[str, Any]) -> None:
    ...
    _pos = pygame.Vector2(prefab.get("x", 0), prefab.get("y", 0))
...
def aplicar_prefab(nombre: str, stage: StageData, offset: pygame.Vector2 = pygame.Vector2(0, 0)) -> bool:  # noqa: B008
