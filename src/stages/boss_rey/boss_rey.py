...
from src.stages.boss_rey.rey_metad import CoordinadorDeMitades, ReyMetad
...
class BossRey(BossBase):
    ...
    def __init__(self, spawn_position: pygame.Vector2) -> None:
        ...
        # AUD-839 — los sheets del Rey completo (walk/spit/hurt/death y los de
        # F2/F3: split, merge, rampage, metad_walk) viven en la carpeta común
        # `assets/sprites/bosses/`; el `base_dir` viejo apuntaba a
        # `assets/maps/stage2_4/`, un mapa que nunca existió (D-04/AV-29).
