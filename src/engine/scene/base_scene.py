...
inherits from. Concrete scenes must implement on_enter, on_exit,
update and draw; on_pause and on_resume have default no-op
implementations and may be overridden as needed.
"""
...
class BaseScene(ABC):
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        Args:
            surface: The internal 320x224 render target.
        """
