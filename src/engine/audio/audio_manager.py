...
class AudioManager:
    ...
    def __init__(self) -> None:
        ...
        self._sound_bank: SoundBank = SoundBank(
    ...
    def play_music(
        ...
        If the name is not registered or the file cannot be loaded, a
        warning is printed and the call is ignored (no exception).
        """
        try:
    ...
    def play_sfx(self, name: str, volume: float = 1.0) -> None:
        ...
        If the name is unknown or the sound cannot be loaded, a warning
