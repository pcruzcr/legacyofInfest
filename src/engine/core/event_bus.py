...
System: engine
Academic Unit: N/A
Description: Singleton-style event bus with queued dispatch. Events are emitted immediately into a queue and dispatched synchronously at the start of each frame via dispatch(). This decouples event producers (entities, systems) from consumers (HUD, AudioManager, SceneManager).
"""
