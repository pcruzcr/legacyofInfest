...
System: engine
Academic Unit: N/A
Description: DeltaClock provides frame-rate-independent delta time for the game loop. Delta values are scaled by a mutable time_scale attribute (for slow-motion/pause effects). The fps property reports the measured frame rate averaged over recent frames.
"""
