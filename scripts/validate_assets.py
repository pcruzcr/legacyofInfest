...
SPRITE_PALETTES: list[tuple[str, set[tuple[int, int, int]]]] = [
    ("sprites/player/*.png", {
        (0, 0, 0), (0, 4, 34), (2, 2, 8), (8, 18, 48),
        (14, 14, 20), (20, 30, 60), (40, 50, 90), (60, 60, 80),
        (80, 80, 110), (100, 80, 50), (200, 180, 100), (220, 180, 140),
    }),  # 10 file(s), 12 colour(s)
    ("sprites/enemies/*.png", {
        (0, 0, 0), (0, 0, 2), (0, 72, 12), (2, 2, 8),
        (2, 6, 14), (4, 54, 4), (6, 8, 14), (6, 86, 26),
        (12, 12, 72), (12, 72, 12), (14, 0, 0), (14, 14, 20),
        (14, 18, 26), (14, 94, 34), (18, 68, 18), (20, 110, 70),
        (24, 4, 54), (26, 26, 86), (26, 86, 26), (28, 0, 0),
        (28, 108, 48), (30, 22, 14), (30, 30, 40), (30, 80, 30),
        (30, 90, 150), (32, 0, 0), (32, 12, 72), (32, 52, 0),
        (34, 34, 94), (34, 94, 34), (38, 18, 68), (40, 10, 10),
        (40, 55, 20), (40, 70, 40), (40, 110, 40), (40, 120, 60),
        (40, 160, 100), (46, 0, 0), (46, 26, 86), (46, 66, 6),
        (48, 48, 108), (48, 108, 48), (50, 30, 80), (50, 65, 15),
        (50, 70, 10), (50, 150, 100), (52, 12, 12), (52, 12, 52),
        (54, 4, 4), (54, 24, 0), (54, 34, 94), (54, 74, 14),
        (55, 65, 10), (60, 45, 30), (60, 60, 70), (60, 60, 120),
        (60, 120, 60), (60, 140, 200), (60, 150, 60), (66, 26, 26),
        (66, 26, 66), (68, 18, 18), (68, 38, 8), (68, 48, 108),
        (68, 88, 28), (70, 35, 50), (70, 80, 0), (70, 140, 80),
        (70, 150, 30), (72, 32, 0), (72, 52, 12), (74, 0, 0),
        (74, 34, 34), (74, 34, 74), (75, 60, 45), (75, 145, 30),
        (75, 155, 95), (78, 32, 10), (80, 30, 30), (80, 50, 20),
        (80, 60, 40), (80, 60, 120), (80, 80, 150), (80, 85, 35),
        (80, 100, 40), (80, 150, 200), (80, 160, 70), (80, 160, 80),
        (80, 170, 110), (85, 50, 10), (86, 46, 6), (86, 66, 26),
        (88, 8, 8), (88, 48, 48), (88, 48, 88), (90, 35, 10),
        (90, 70, 50), (90, 95, 30), (90, 160, 20), (90, 180, 80),
        (92, 46, 24), (94, 40, 14), (94, 54, 14), (94, 74, 34),
        (95, 95, 155), (95, 155, 95), (96, 140, 148), (100, 20, 20),
        (100, 50, 10), (100, 60, 60), (100, 60, 100), (100, 75, 45),
        (100, 75, 60), (100, 140, 180), (100, 170, 60), (100, 210, 80),
        (104, 58, 36), (105, 130, 30), (108, 68, 28), (108, 88, 48),
        (110, 60, 5), (110, 65, 65), (110, 80, 50), (110, 95, 80),
        (110, 160, 170), (110, 170, 210), (110, 210, 50), (110, 210, 140),
        (114, 150, 156), (115, 65, 65), (115, 90, 60), (115, 95, 155),
        (115, 135, 75), (115, 205, 50), (120, 40, 20), (120, 40, 180),
        (120, 50, 180), (120, 66, 40), (120, 80, 40), (120, 90, 55),
        (120, 100, 60), (120, 100, 80), (120, 120, 60), (120, 120, 200),
        (120, 180, 180), (120, 180, 220), (120, 220, 210), (128, 164, 170),
        (130, 30, 40), (130, 65, 25), (130, 110, 90), (130, 130, 55),
        (130, 160, 70), (130, 170, 160), (130, 220, 40), (132, 2, 2),
        (135, 55, 35), (135, 95, 95), (135, 95, 135), (140, 40, 160),
        (140, 55, 30), (140, 105, 75), (140, 110, 70), (140, 120, 100),
        (140, 176, 182), (140, 210, 240), (140, 250, 100), (145, 190, 50),
        (146, 16, 16), (150, 30, 0), (150, 40, 40), (150, 60, 150),
        (150, 70, 190), (150, 86, 52), (150, 100, 90), (150, 125, 95),
        (150, 250, 70), (154, 24, 24), (155, 115, 75), (155, 125, 85),
        (155, 135, 95), (155, 245, 70), (160, 70, 20), (160, 70, 50),
        (160, 80, 160), (160, 120, 200), (160, 125, 80), (160, 200, 120),
        (168, 38, 38), (170, 70, 140), (170, 80, 15), (170, 90, 70),
        (170, 100, 50), (170, 190, 220), (170, 220, 90), (170, 255, 60),
        (180, 50, 50), (180, 60, 30), (180, 80, 70), (180, 80, 220),
        (180, 100, 220), (180, 110, 220), (180, 140, 40), (180, 140, 100),
        (180, 140, 220), (180, 210, 210), (180, 220, 250), (180, 220, 255),
        (185, 230, 70), (190, 50, 50), (190, 80, 40), (190, 160, 120),
        (190, 230, 220), (195, 75, 40), (195, 75, 45), (200, 75, 40),
        (200, 80, 80), (200, 80, 240), (200, 90, 220), (200, 120, 240),
        (200, 160, 240), (200, 220, 200), (200, 255, 140), (210, 50, 10),
        (210, 90, 30), (210, 110, 210), (210, 120, 250), (210, 255, 110),
        (210, 255, 255), (215, 85, 85), (220, 60, 60), (220, 90, 60),
        (220, 100, 255), (220, 130, 220), (220, 140, 255), (220, 180, 80),
        (220, 180, 255), (225, 60, 40), (230, 110, 80), (230, 120, 200),
        (235, 130, 120), (240, 80, 80), (240, 120, 255), (240, 160, 255),
        (240, 255, 160), (245, 130, 90), (250, 90, 80), (250, 125, 90),
        (255, 100, 100), (255, 110, 90), (255, 120, 120), (255, 130, 130),
        (255, 140, 80), (255, 140, 130), (255, 140, 255), (255, 180, 180),
        (255, 255, 255),
    }),  # 124 file(s), 257 colour(s)
    ("sprites/bosses/*.png", {
